...
var _bar_w = _gw - _pad * 2;
var _bar_h = 14;

// Rank + title — centered above the bar (colored per tier)
...
// --- Below bar: SCOOPS count (left), Last grade (right) ---
var _below_y = _bar_y + _bar_h + 6;
draw_set_halign(fa_left);
draw_set_valign(fa_top);
draw_set_color(c_white);
draw_text(_bar_x, _below_y - 8, string(global.scoops) + " / 800");
...
draw_text(_bar_x + _bar_w, _below_y - 8, "Last Pizza: " + global.last_rank);
